...
public:
    ...
    {
        RecordMeterDialog->setWindowTitle(QApplication::translate("RecordMeterDialog", "MeterRecord", Q_NULLPTR));
        label->setText(QApplication::translate("RecordMeterDialog", "Date", Q_NULLPTR));
        dateEdit->setDisplayFormat(QApplication::translate("RecordMeterDialog", "yyyy-MM-dd", Q_NULLPTR));
        label_2->setText(QApplication::translate("RecordMeterDialog", "BuildingID", Q_NULLPTR));
        label_3->setText(QApplication::translate("RecordMeterDialog", "RoomID", Q_NULLPTR));
        waterLabel->setText(QApplication::translate("RecordMeterDialog", "Water", Q_NULLPTR));
        wattLabel->setText(QApplication::translate("RecordMeterDialog", "Watt", Q_NULLPTR));
        gasLabel->setText(QApplication::translate("RecordMeterDialog", "Gas", Q_NULLPTR));
        insertRecordPushButton->setText(QApplication::translate("RecordMeterDialog", "Add", Q_NULLPTR));
        confirmPushButton->setText(QApplication::translate("RecordMeterDialog", "Submit", Q_NULLPTR));
    } // retranslateUi
