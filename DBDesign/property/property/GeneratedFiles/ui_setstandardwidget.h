...
public:
    ...
    void setupUi(QWidget *setStandardWidget)
    {
        ...
        startDateDateEdit->setDateTime(QDateTime(QDate(2015, 1, 1), QTime(0, 0, 0)));
    ...
    void retranslateUi(QWidget *setStandardWidget)
    {
        ...
        label_2->setText(QApplication::translate("setStandardWidget", "\347\224\237\346\225\210\346\227\245\346\234\237", 0));
